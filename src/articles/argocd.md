...
1. Install Argo CD on a **Kubernetes ([kubernetes](kubernetes))** Cluster, using **kubectl ([kubectl](kubernetes/kubectl.md))**.
...
2. Add **Traefik IngressRoute ([traefik](apps/traefik.md))**.
...
2. Add new repository in ArgoCD via **kubectl ([kubectl](kubernetes/kubectl.md))** or the GUI
